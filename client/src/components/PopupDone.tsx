      ...
      <Modal.Root>
        ...
        <Modal.Portal>
          ...
          <Modal.Content className="modal-content z-20 flex flex-col rounded-2xl bg-softBeige drop-shadow-lg">
            <Modal.Title className="px-16 m-0 flex justify-center text-3xl font-bold text-newLeafGreen">
              {props.title}
            </Modal.Title>
            ...
            <div className="my-5 flex justify-center gap-8">
              <Modal.Close asChild>
                <button
                  className="rounded-full bg-newLeafGreen w-1/4 px-3 py-2 text-sm font-semibold text-white shadow-md shadow-newLeafGreen hover:-translate-y-1 hover:shadow-lg hover:shadow-newLeafGreen lg:px-5 lg:py-3 lg:text-base lg:font-bold"
                  type="button"
                >
                  Done
                </button>
