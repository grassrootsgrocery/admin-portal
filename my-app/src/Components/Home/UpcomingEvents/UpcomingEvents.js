    ...
    <>
      <div class="eventInfo">
        ...
        <div class="primaryInfoDiv">
          <div class="primaryInfoSection">
            {" "}
            Volunteer Group <br /> <b>{props.group}</b>
          </div>
          <div class="primaryInfoSection">
            {" "}
            Pickup Location <br /> <b>{props.location}</b>
          </div>
          <div class="primaryInfoSection">
            {" "}
            Drivers Needed <br /> <b>{props.needed}</b>
          </div>
        </div>
  ...
  return (
    <>
      <div id="upcomingEvents">
        <div class="upcomingEventsHeader">
          <p>
            <b>Upcoming Events</b>
          </p>
        </div>
        ...
        <Link className="upcoming_see_more" to="/">
          See More
        </Link>
      </div>
    </>
